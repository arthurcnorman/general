...
activity. Artificial Intellenence tools offer to make things yet simpler so
that to make computers jump to your needs all that is called for will be
a brief sketch of what you would like. \\
This superficial simplicity hides a great deal of mess. For large scale uses
of computation there can be a truly serious challenge deciding on and
describing just what is needed. It may be straightforwad to say ``create
a nice word processor, image editor, business management suite or operating
system  and make it do everything anybody would want ans also be easy to use''
but refining the high level explanation (which is just what your sales-force
needs in order to market the product!) into conrete detail is liable to be
a big job. Here, in contast to looking at the understandable challenges 
in the large the concentration is on smaller tasks where often the objective
will be easy to specify with full precision. The fact that there are many
of these that are very far from straightforward matters because in the end
the huge applications are built from many many little blocks of code each of
which does something simpler. If aiming for perfection when creating these
building blocks raises diffiulty it should be obvious that there will be
issues that could be be raised against the whole. Issues beyond those of
mis-judgement about user needs, problems associated with circumstances
changing since the software was released or insecurity or misbehaviour down to
simple bugs.\\
So here you will find a collection of tasks, many of
which ought by rights to be simple, together with explanations that if
one takes a proper perfectionist stance that are nothing like as
trivial as they may at first seem. Now of course if you have access to an
expert (human or artifical) who has encyclopaedic knowledge of the literature 
in most cases there will be known ways to get things right. But it is perhaps
good to be aware of the levels of challenge for at least three reasons:
without awareness of possible challenges you may end up aiming for something
that will unnecessarily fail in unusual cases or that is not as efficient as
it could be, you could start out asking for something that is effectively
impossible to achieve, or you might simply take the view that understanding how
things work is a self-justifying challenge.
}\end{quotation}
...
There are basically three reasons for investigating this difficulty. The
...
achieve more in the future. Finally if you intend to solve a problem by
picking up a ready-made solution or commisioning somebody or something else
to sort things out for you it will be really good to understand in
real detail what you are asking for.
