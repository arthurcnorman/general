...
// that amount all at once.
    ...
    constexpr working_float(uint64_t hi, uint64_t lo,
        ...
        x(xx)
    {   if ((g>>63) != 0) mantissa++; // will never overflow in cases I use.
// Also in the case I use the guard word never has the value exact;y 0.5ULP
// which (if it arose) might make me want to take special action to round
// to even.
    }

    working_float(uint128_t mm, int xx);
...
working_float(0x91ff83775423cc06,0x7b6306a34627ddcf,0x1c5a40917d0fa664,-637),
working_float(0xa21727db38cb002f,0xb8ada00e5a506a7c,0xf1218f2b86615f63,-584),
working_float(0xb3f4e093db73a093,0x59ed216765690f56,0x8fe5b452e6b166cd,-531),
working_float(0xc7caba6e7c5382c8,0xfe64a52ee96b8fc0,0xcbeb481c23d5e711,-478),
working_float(0xddd0467c64bce4a0,0xac7cb3f6d05ddbde,0xe26ca6063461fffa,-425),
working_float(0xf64335bcf065d37d,0x4d4617b5ff4a16d5,0xaa09501d5954a559,-372),
working_float(0x88b402f7fd75539b,0x11dbcb0218ebb414,0x690c0db23e2755ee,-318),
working_float(0x97c560ba6b0919a5,0xdccd879fc967d41a,0x021da8c6f15375a1,-265),
working_float(0xa87fea27a539e9a5,0x3f2398d747b36224,0x2a1fee40d90aab31,-212),
working_float(0xbb127c53b17ec159,0x5560c018580d5d52,0x3a63263a538df733,-159),
working_float(0xcfb11ead453994ba,0x67de18eda5814af2,0x0b5b1aa028ccd99e,-106),
working_float(0xe69594bec44de15b,0x4c2ebe687989a9b3,0xbf716c1add27f085,-53),
working_float(0x8000000000000000,0x0000000000000000,0x0000000000000000,1),
working_float(0x8e1bc9bf04000000,0x0000000000000000,0x0000000000000000,54),
working_float(0x9dc5ada82b70b59d,0xf020000000000000,0x0000000000000000,107),
working_float(0xaf298d050e4395d6,0x9670b12b7f410000,0x0000000000000000,160),
working_float(0xc2781f49ffcfa6d5,0x3cbf6b71c76b25fb,0x50f8080000000000,213),
working_float(0xd7e77a8f87daf7fb,0xdc33745ec97be906,0x3298e889d933b040,266),
working_float(0xefb3ab16c59b14a2,0xc5cfe94ef3ea101e,0x388da035c8f16477,319),
working_float(0x850fadc09923329e,0x03e2cf6bc604ddb0,0x74a7ef0198791097,373),
working_float(0x93ba47c980e98cdf,0xc66f336c36b10137,0x0234f3fd7b08dd39,426),
working_float(0xa402b9c5a8d3a6e7,0x5f16206c9c6209a6,0x39caef6ed62f905b,479),
working_float(0xb616a12b7fe617aa,0x577b986b314d6009,0x2381cf8591999d63,532),
working_float(0xca28a291859bbf93,0x7d7b8f7503cfdcfe,0xd11f91ff10629770,585),
working_float(0xe070f78d3927556a,0x85bbe253f47b1417,0x0f118a2758e233b1,638),
working_float(0xf92e0c3537826145,0xa7709a56ccdf8a82,0x866caba98a7e2dab,691),
...
working_float(0xa6dd04c8d2ce9fde,0x2de38123a1c3cffc,0x20305d0244e091ba,-13606),
working_float(0xde42ff8d37cad87f,0x1463ef488d5226cb,0xb171e37a76c65371,-12756),
working_float(0x9406af8f83fd6265,0x4b4de34e0ebc3e06,0x45efb05f20cf48b3,-11905),
working_float(0xc52ba8a6aeb15d92,0x9e98cb984f0d3050,0xa42303e570b87e7f,-11055),
working_float(0x8350bf3c91575a87,0xe79e236bf8bf47a8,0xe8a94db92ca5841f,-10204),
working_float(0xaee973911228abca,0xe3187c34500d9ab3,0xb7d1f78b317fae11,-9354),
working_float(0xe8fb7dc2dec0a404,0x598eec7d41754c09,0x5ad05b84c7c4be7d,-8504),
working_float(0x9b2a840f28a1638f,0xe393a9c032fb0c34,0x660bdfd108ba7989,-7653),
working_float(0xceae534f34362de4,0x492512d4f2ead2cb,0x8263ca5cbc774bd9,-6803),
working_float(0x89a63ba4c497b50e,0x6c83ad1260ff20f4,0xc098e6ed0bfbd6f6,-5952),
working_float(0xb759449f52a711b2,0x68e1eb75340122d4,0x0fd924be26af7592,-5102),
working_float(0xf4385d0975edbabe,0x1f4bf6653cd3b977,0xddee7f83569c8b33,-4252),
working_float(0xa2a682a5da57c0bd,0x87a601586bd3f698,0xf53e94d1b2357c32,-3401),
working_float(0xd8a66d4a505de96b,0x5ae1b25946117390,0x4d0525af79e132c3,-2551),
working_float(0x9049ee32db23d21c,0x7132d332e3f204d4,0xe7317d62209b6a93,-1700),
working_float(0xc0314325637a1939,0xfa911155fefb5308,0xa23e2ed27766e8cc,-850),
working_float(0x8000000000000000,0x0000000000000000,0x0000000000000000,1),
working_float(0xaa7eebfb9df9de8d,0xddbb901b98feeab7,0x851e4cbf3de2f98a,851),
working_float(0xe319a0aea60e91c6,0xcc655c54bc5058f8,0x9c6583981d134cba,1701),
working_float(0x973f9ca8cd00a68c,0x6c8d3fca02ca6de6,0xb0d7ba426777344d,2552),
working_float(0xc976758681750c17,0x650d3d28f18b50ce,0x526b988275249b0f,3402),
working_float(0x862c8c0eeb856ecb,0x085bccd5c05ee9f9,0xecff2e2c1eae9db9,4253),
working_float(0xb2b8353b3993a7e4,0x4257ac3b4c1d7794,0x7704bd1bb5a5802f,5103),
working_float(0xee0ddd84924ab88c,0x2d4070f33b21ab7b,0xc20578fa3851488b,5953),
working_float(0x9e8b3b5dc53d5de4,0xa74d28ce329ace52,0x6a3197bbebe3034f,6804),
working_float(0xd32e203241f4806f,0x3f50c802040f4ccc,0x03baa2f38e35464f,7654),
working_float(0x8ca554c020a1f0a6,0x5dfed09922680a06,0xaef839a8a7f6a14c,8505),
working_float(0xbb570a9a9bd977cc,0x4c808753bb22fef8,0x6fc5802cde0b3272,9355),
working_float(0xf9895d25d88b5a8a,0xfdd08c4da13655ec,0xf02c90b784b4227a,10205),
working_float(0xa630ef7d5699fe45,0x50e3660235410f98,0xfca81f202c5d111a,11056),
working_float(0xdd5dc8a2bf27f3f7,0x95aa118ec1d08317,0x8909e424a112a3cd,11906),
working_float(0x936e07737dc64f6d,0x8c474bb609f40287,0xd2fea4fd957ea18e,12757),
working_float(0xc46052028a20979a,0xc94c153f804a4a92,0x65761fb2444e2267,13607),
working_float(0x82c952e37be11cb4,0x6e6c12aa02b9a1ec,0x538567bfbe0b117a,14458),
working_float(0xae3511626ed559f0,0x7ef5f8c1b3a0771c,0x5a43d43795f92ea2,15308),
