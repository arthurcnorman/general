...
where that value is
$0.1591549430918953357688837633725143620344596457404564487476\ldots$
So now we need to multiply that number by the big integer
$628300000000000000000000000000000000000000000000000$ which is the
proper way of viewing the number whose sine we are wanting to find.
