...
projefct scope amazingly is a great illustration of the fact that many
tasks can end up having an amazingly greater scope then is at first
apparent, and each of the components that end up being constructed need
invention and will build on multiple smaller tasks some of which
can turn out to be individually challenging.
But for many practical reasons we will be concentrating
