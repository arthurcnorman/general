...
int main()
{   std::cout << "Starting\n";
    show128("zero", 0.0_f128);

    show128("1 + 1 = 2", 1.0_f128+1.0_f128);
    show128("1 - 1 = 0", 1.0_f128-1.0_f128);
    show128("-1 + 1 = 0", -1.0_f128+1.0_f128);
    show128("-1 - 1 = -2", -1.0_f128-1.0_f128);

    show128("2 + 1 = 3", 2.0_f128+1.0_f128);
    show128("2 - 1 = 1", 2.0_f128-1.0_f128);
    show128("-2 + 1 = -1", (-2.0_f128)+1.0_f128);
    show128("-2 - 1 = -3", -2.0_f128-1.0_f128);

    show128("1 + 2 = 3", 1.0_f128+2.0_f128);
    show128("1 - 2 = -1", 1.0_f128-2.0_f128);
    show128("-1 + 2 = 1", -1.0_f128+2.0_f128);
    show128("-1 - 2 = -3", -1.0_f128-2.0_f128);
