...
symbolic inline procedure math_x_height x;
  distRar(31*s, 71);
...
symbolic procedure math_quad n;
  if n = 10 then distInt 10
  else if n=9 then distRat(37, 4)
  else if n=8 then distRat(17, 2)
  else if n=7 then distRat(295, 36)
  else if n=6 then distRat(23, 3)
  else if n=5 then distRat(265,36)
  else error(1, "Bad argument to math_quad");
...
symbolic procedure num1 n;
  if n = 10   then distReal 6.765080
  else if n=9 then distReal 5.820651
  else if n=8 then distReal 5.570648
  else if n=7 then distReal 5.126191
  else if n=6 then distReal 4.876188
  else if n=5 then distReal 4.626205
  else error(1, "Bad argument to num1");
...
symbolic procedure num2 n;
  if n = 10   then distReal 3.937320
  else if n=9 then distReal 3.687318
  else if n=8 then distReal 3.270664
  else if n=7 then distReal 2.687321
  else if n=6 then distReal 2.353986
  else if n=5 then distReal 1.937320
  else error(1, "Bad argument to num2");
