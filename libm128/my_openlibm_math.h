...
#define	HUGE_VALL	(float128_t)HUGE_VAL
...
/*
 * float128_t versions of ISO/POSIX math functions
 * ACN renames these to avoid conflicts with built in versions that
// are based on long floats.
 */
#if __ISO_C_VISIBLE >= 1999
OLM_DLLEXPORT float128_t	acosh128(float128_t);
OLM_DLLEXPORT float128_t	acos128(float128_t);
OLM_DLLEXPORT float128_t	asinh128(float128_t);
OLM_DLLEXPORT float128_t	asin128(float128_t);
OLM_DLLEXPORT float128_t	atan2128(float128_t, float128_t);
OLM_DLLEXPORT float128_t	atanh128(float128_t);
OLM_DLLEXPORT float128_t	atan128(float128_t);
OLM_DLLEXPORT float128_t	cbrt128(float128_t);
OLM_DLLEXPORT float128_t	ceil128(float128_t);
OLM_DLLEXPORT float128_t	copysign128(float128_t, float128_t) __pure2;
OLM_DLLEXPORT float128_t	cosh128(float128_t);
OLM_DLLEXPORT float128_t	cos128(float128_t);
OLM_DLLEXPORT float128_t	erfc128(float128_t);
OLM_DLLEXPORT float128_t	erf128(float128_t);
OLM_DLLEXPORT float128_t	exp2128(float128_t);
OLM_DLLEXPORT float128_t	exp128(float128_t);
OLM_DLLEXPORT float128_t	expm1128(float128_t);
OLM_DLLEXPORT float128_t	fabs128(float128_t) __pure2;
OLM_DLLEXPORT float128_t	fdim128(float128_t, float128_t);
OLM_DLLEXPORT float128_t	floor128(float128_t);
OLM_DLLEXPORT float128_t	fma128(float128_t, float128_t, float128_t);
OLM_DLLEXPORT float128_t	fmax128(float128_t, float128_t) __pure2;
OLM_DLLEXPORT float128_t	fmin128(float128_t, float128_t) __pure2;
OLM_DLLEXPORT float128_t	fmod128(float128_t, float128_t);
OLM_DLLEXPORT float128_t	frexp128(float128_t value, int *); /* fundamentally !__pure2 */
OLM_DLLEXPORT float128_t	hypot128(float128_t, float128_t);
OLM_DLLEXPORT int		ilogb128(float128_t) __pure2;
OLM_DLLEXPORT float128_t	ldexp128(float128_t, int);
OLM_DLLEXPORT float128_t	lgamma128(float128_t);
OLM_DLLEXPORT long long	llrint128(float128_t);
OLM_DLLEXPORT long long	llround128(float128_t);
OLM_DLLEXPORT float128_t	log10128(float128_t);
OLM_DLLEXPORT float128_t	log1p128(float128_t);
OLM_DLLEXPORT float128_t	log2128(float128_t);
OLM_DLLEXPORT float128_t	logb128(float128_t);
OLM_DLLEXPORT float128_t	log128(float128_t);
OLM_DLLEXPORT long		lrint128(float128_t);
OLM_DLLEXPORT long		lround128(float128_t);
OLM_DLLEXPORT float128_t	modf128(float128_t, float128_t *); /* fundamentally !__pure2 */
OLM_DLLEXPORT float128_t	nan128(const char *) __pure2;
OLM_DLLEXPORT float128_t	nearbyint128(float128_t);
OLM_DLLEXPORT float128_t	nextafter128(float128_t, float128_t);
//OLM_DLLEXPORT double		nexttoward128(double, float128_t);
//OLM_DLLEXPORT float		nexttowardf128(float, float128_t);
OLM_DLLEXPORT float128_t	nexttoward128(float128_t, float128_t);
OLM_DLLEXPORT float128_t	pow128(float128_t, float128_t);
OLM_DLLEXPORT float128_t	remainder128(float128_t, float128_t);
OLM_DLLEXPORT float128_t	remquo128(float128_t, float128_t, int *);
OLM_DLLEXPORT float128_t	rint128(float128_t);
OLM_DLLEXPORT float128_t	round128(float128_t);
OLM_DLLEXPORT float128_t	scalbln128(float128_t, long);
OLM_DLLEXPORT float128_t	scalbn128(float128_t, int);
OLM_DLLEXPORT float128_t	sinh128(float128_t);
OLM_DLLEXPORT float128_t	sin128(float128_t);
OLM_DLLEXPORT float128_t	sqrt128(float128_t);
OLM_DLLEXPORT float128_t	tanh128(float128_t);
OLM_DLLEXPORT float128_t	tan128(float128_t);
OLM_DLLEXPORT float128_t	tgamma128(float128_t);
OLM_DLLEXPORT float128_t	trunc128(float128_t);
#endif /* __ISO_C_VISIBLE >= 1999 */

/* Reentrant version of lgammal. */
#if __BSD_VISIBLE
OLM_DLLEXPORT float128_t	lgamma128_r(float128_t, int *);

/*
 * Single sine/cosine function.
 */
OLM_DLLEXPORT void	sincos128(float128_t, float128_t *, float128_t *);
#endif	/* __BSD_VISIBLE */
